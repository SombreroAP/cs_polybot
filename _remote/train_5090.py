...
def main():
    ...
    ap.add_argument("--output", default=r"E:\training\cs2_qwen14b_5090_v1")
    ap.add_argument("--max-steps", type=int, default=-1,
                    help="cap total training steps (for smoke tests). -1 = use epochs.")
    ap.add_argument("--no-merge", action="store_true",
                    help="skip the slow merged-16bit save (adapter only).")
    args = ap.parse_args()
    ...
    # 6. Save
    print("\n[6/6] saving adapter" + ("" if args.no_merge else " + merged 16-bit"))
