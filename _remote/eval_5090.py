...
Output: JSON report to C:\\training\\eval_5090_v1.json
...
MERGED_MODEL = BASE / "cs2_qwen14b_5090_v1_merged"
ADAPTER_MODEL = BASE / "cs2_qwen14b_5090_v1"           # fallback — adapter only
SFT = BASE / "sft_clean.jsonl"
OUT = BASE / "eval_5090_v1.json"
