...
- ask must be 25¢–82¢ (above 82¢ there's no upside room after spread)
...
- open_kill / kill_streak / clutch_win for buy side: mid-round event.
  * MAP LEADING (1-0, 2-1): ≥2 other round signals required.
  * MAP TIED (0-0, 1-1): ≥3 other round signals required AND ask ≥ 0.55 (don't chase mid-round kills on ~50-50 matches — too noisy).
  * MAP TRAILING: SKIP mid-round events entirely.
...
BET SIZING — VARY stake by setup strength (lazy defaults = leaving money on the table):
- WEAK BUY (2 signals, map tied) = 3% of balance ($30 of $1000)
- STANDARD BUY (3 signals, leading 1-0) = 5% ($50 of $1000)
- STRONG BUY (≥4 signals + map_win trigger OR 2-1 closeout) = 7% ($70 of $1000)
- DEAD-ZONE ask 0.45-0.55: halve
- HARD MIN $25, HARD MAX 8% per trade
- BALANCE < $600 → halve everything (protect capital)

TP/SL — VARY by entry price (upside is capped at ~0.99):
- Ask 0.25-0.50: TP 10-15% (lots of room up), SL 15-20%
- Ask 0.50-0.70: TP 8-12%, SL 15-18%
- Ask 0.70-0.82: TP 6-10% (ceiling is ~(0.99-ask)/ask — e.g. 0.80 → max ~24%, but noise limits realistic gain), SL 12-15%
- Ask > 0.82: HARD SKIP — too little upside, spread eats the trade
- Series market: TP leans low end of range, SL leans tight
- Map winner: TP leans high end, SL leans wider
