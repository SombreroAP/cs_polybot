...
- LEADING in maps (buy side 1-0, or 2-1 closeout): STRONG edge → BUY if ≥1 round signal agrees.
- TIED in maps (0-0, 1-1): need ≥2 round signals AND current-map round lead (≥3).
- TRAILING in maps (buy side 0-1, 0-2, 1-2): need BOTH ≥3 round-lead on current map AND eco advantage. Otherwise SKIP — do not buy a trailing team on round momentum alone.
